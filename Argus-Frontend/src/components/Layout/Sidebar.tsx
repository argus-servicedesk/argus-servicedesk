...
const navGroups: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/eod', icon: ClipboardList, label: 'EOD Operations', superAdminOnly: true },
      { to: '/oms', icon: ShoppingCart, label: 'OMS', superAdminOnly: true },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/domain', icon: Globe, label: 'Domain Ops', badge: 'LIVE', superAdminOnly: true },
