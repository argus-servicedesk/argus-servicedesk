    ...
    <div className="animate-fade-in grid grid-cols-12 gap-6">
      ...
      <div className="col-span-4 space-y-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <button 
            onClick={() => { setSelectedRole(null); setIsCreating(true); }}
          ...
          <div className="p-6 flex-1 flex flex-col">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex gap-2">
                {!isCreating && selectedRole?.isCustom && (
                  <button 
            ...
            <div className="flex-1 flex flex-col min-h-0 border-t border-slate-100 pt-6">
              <div className="flex items-center justify-between mb-4">
                <h4 className="font-bold text-slate-700 flex items-center gap-2">
                  ...
                  <span className="text-xs font-normal text-slate-400">({selectedRole?.permissions.length || 0} assigned)</span>
                </h4>
              ...
              <div className="flex-1 overflow-y-auto pr-2 space-y-1">
                {filteredPermissions.map(perm => {
                  ...
                  return (
                    ...
                    >
                      <div>
                        <p className="text-sm font-semibold font-mono">{perm.code}</p>
                        <p className="text-xs opacity-70">{perm.name} &middot; {perm.description}</p>
                      </div>
